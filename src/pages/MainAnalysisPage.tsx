    ...
    <div className="px-10 py-6 overflow-hidden">
      ...
      >
        <article className="flex flex-col">
          ...
          <div className="w-125 h-68 bg-surface-base rounded-3xl border border-gray-200 p-3 items-center justify-center flex gap-5">
        ...
        <article className="flex flex-col">
          ...
          <div className="w-125 h-68 bg-surface-base rounded-3xl border border-gray-200 pr-5 items-center justify-center flex">
            <BubbleChart />
        ...
        <article className="flex flex-col">
          ...
          <div className="w-125 h-68 bg-surface-base rounded-3xl border border-gray-200 py-3 items-center justify-center">
            <DoubleChart />
          </div>
        </article>
      </section>
