...
export default function ColorBar({ title, data, onClose }: ColorBarProps) {
        ...
        {chartData.map((item, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-4">
              ...
              {/* 관련 아이템 버튼 */}
              <button className="px-2 py-1 bg-[#F6F8FA] rounded-lg text-xs font-bold text-[#555] hover:bg-gray-50 transition-all">
                관련 아이템
              </button>
            </div>
          </div>
