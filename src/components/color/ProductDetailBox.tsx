  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 min-w-0 font-semibold">
        <span className="mb-3 text-tx-alt text-sm truncate">
          {product_name}
        </span>

        <div className="flex items-center min-w-0 my-1 text-xs">
          <span className="flex-shrink-0 mr-3 text-icon-neutral">색상</span>
          <div
            className="flex-shrink-0 w-3 h-3 mr-2 rounded-full"
            style={{ backgroundColor: color }}
          />
          <span className="font-normal text-tx-alt truncate">
            {color_text}
          </span>
        </div>

        <div className="flex items-center min-w-0 mb-1 text-xs">
          <span className="flex-shrink-0 mr-3 text-icon-neutral">소재</span>
          <span className="font-normal text-tx-alt truncate">
            {material}
          </span>
        </div>
