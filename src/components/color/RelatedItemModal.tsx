  ...
  if (selectedItemcode) {
    return (
      <div className="fixed inset-0 z-[130] flex items-center justify-center p-4">
        ...
        />
        <div className="relative w-full max-w-[900px] max-h-[90vh] overflow-y-auto bg-white rounded-2xl p-8 shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-[#ECEEF0] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
