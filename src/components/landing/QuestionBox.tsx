function QuestionBox({ text }: { text: string }) {
  return (
    <div
      className="border-box inline-flex px-5 lg:px-10 py-3 lg:py-4 justify-center items-center gap-[10px] rounded-full
        ...
        text-[#151515] font-semibold text-sm lg:text-2xl leading-8
      "
    >
      {text}
    </div>
